            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="birth_chart" className='text-gray-700'>Birth Chart Reading</option>
                  <option value="tarot_reading" className='text-gray-700'>Tarot Reading</option>
                  <option value="compatibility" className='text-gray-700'>Compatibility Analysis</option>
                  <option value="horoscope" className='text-gray-700'>Personal Horoscope</option>
                </select>
              </div>
            </div>
